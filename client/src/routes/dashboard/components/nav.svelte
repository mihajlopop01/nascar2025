...
<nav>
    ...
    <div class="nav-container">
        ...
        <a class="nav-font {selectedNav === 'dashboard' ? 'active-nav' : ''}" href="#" onclick={()=>selectedNav="dashboard"}>
        ...
        <a class="nav-font {selectedNav === 'breakdown' ? 'active-nav' : ''}" href="#" onclick={()=>selectedNav="breakdown"}>
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"
                class="nav-icon">
                <path
        ...
        <a class="nav-font {selectedNav === 'support' ? 'active-nav' : ''}" href="#" onclick={()=>selectedNav="support"}>
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"
                class="nav-icon">
                <path
        ...
        <a class="nav-font {selectedNav === 'calendar' ? 'active-nav' : ''}" href="#" onclick={()=>selectedNav="calendar"}>
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"
                class="nav-icon">
                <path
    ...
    <div class="nav-container">
        ...
        <a class="nav-font {selectedNav === 'admin' ? 'active-nav' : ''}" href="#" onclick={()=>selectedNav="admin"}>
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"
                class="nav-icon">
                <path
        ...
        <a class="nav-font {selectedNav === 'support_admin' ? 'active-nav' : ''}" href="#" onclick={()=>selectedNav="support_admin"}>
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"
                class="nav-icon">
                <path
                    d="M440-120v-80h320v-284q0-117-81.5-198.5T480-764q-117 0-198.5 81.5T200-484v244h-40q-33 0-56.5-23.5T80-320v-80q0-21 10.5-39.5T120-469l3-53q8-68 39.5-126t79-101q47.5-43 109-67T480-840q68 0 129 24t109 66.5Q766-707 797-649t40 126l3 52q19 9 29.5 27t10.5 38v92q0 20-10.5 38T840-249v49q0 33-23.5 56.5T760-120H440Zm-80-280q-17 0-28.5-11.5T320-440q0-17 11.5-28.5T360-480q17 0 28.5 11.5T400-440q0 17-11.5 28.5T360-400Zm240 0q-17 0-28.5-11.5T560-440q0-17 11.5-28.5T600-480q17 0 28.5 11.5T640-440q0 17-11.5 28.5T600-400Zm-359-62q-7-106 64-182t177-76q89 0 156.5 56.5T720-519q-91-1-167.5-49T435-698q-16 80-67.5 142.5T241-462Z" />
        ...
        <a class="nav-font {selectedNav === 'monitor' ? 'active-nav' : ''}" href="#" onclick={()=>selectedNav="monitor"}>
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"
                class="nav-icon">
                <path
        ...
        <a class="nav-font {selectedNav === 'time' ? 'active-nav' : ''}" href="#" onclick={()=>selectedNav="time"}>
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"
                class="nav-icon">
                <path
    ...
    <div class="nav-container hidden">
        ...
        <a class="nav-font {selectedNav === 'settings' ? 'active-nav' : ''}" href="#" onclick={toggleActiveNav("settings")}>
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"
                class="nav-icon">
                <path
    ...
    <div id="user-container">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" height="32px" viewBox="0 -960 960 960" width="32px" fill="#ababab">
